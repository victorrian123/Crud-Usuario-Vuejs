<template>
	<div id="app" class="container">
		...
		<b-card>
			...
			<b-button @click="obterUsuarios" size="lg" class="ml-4" variant="primary">Mostrar Usuarios</b-button>
		</b-card>
		<hr>
		<b-list-group>
			<b-list-group-item v-for="(usuario, id) in usuarios" key="id">
				...
				<b-button variant="danger" size="lg" class="ml-3" @click="excluir(id)">Excluir</b-button>
			</b-list-group-item>
		</b-list-group>
	</div>
</template>
